    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(request.getDesiredResourceState(), callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-Transfer-User::Update::PreUpdateCheck", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-Transfer-User::Update::first", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                    ...
                    proxy.initiate("AWS-Transfer-User::Update::second", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
